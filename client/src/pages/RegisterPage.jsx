...
const RegisterPage = () => {
	// State variables for error handling, loading status, and form inputs
	...
	const handleRegister = async () => {
		if (validateFields()) {
			...
			await client
				...
				.then((res) => {
					// Dispatch actions on successful registration
		...
		<Box minH="calc(100vh - 5rem)" maxW="2xl" mx="auto" p={6}>
			<Box
				...
				<Flex direction="column" gap={4}>
					...
					{/* Registration button and alternative options */}
					<Box mt={6}>
						<Button
